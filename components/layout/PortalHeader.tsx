  ...
  return (
    <header className={cn(
      ...
      <div className="relative flex items-start justify-between gap-6">
        <div>
          <h1 className="text-[26px] font-semibold tracking-tight text-[var(--kfx-text)]">{title}</h1>
          {subtitle && (
            <p className="text-[14px] text-[var(--kfx-text-muted)] mt-1.5 max-w-xl leading-relaxed">{subtitle}</p>
          )}
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {clientId && <NotificationBell recipient="client" clientId={clientId} />}
