...
export function PortalWhatsAppButton() {
  ...
  function handleClick() {
    ...
    const message = 'Hello! I need support with my Keystone FX client portal account.'
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-full shadow-2xl hover:shadow-green-500/50 hover:scale-110 transition-all duration-300">
