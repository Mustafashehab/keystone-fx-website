    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-6">{t(lang, "about.mission.title")}</h2>
            <p className="text-slate-600 leading-relaxed mb-4">{t(lang, "about.mission.text1")}</p>
            <p className="text-slate-600 leading-relaxed">{t(lang, "about.mission.text2")}</p>
          </div>
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">{t(lang, "about.regulation.title")}</h2>
          <p className="text-slate-600 leading-relaxed mb-8">{t(lang, "about.regulation.text")}</p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 p-12 text-center text-white shadow-2xl">
          <h2 className="text-3xl font-bold mb-4">{t(lang, "about.cta.title")}</h2>
          <p className="mx-auto max-w-2xl text-slate-300 mb-8">{t(lang, "about.cta.subtitle")}</p>
