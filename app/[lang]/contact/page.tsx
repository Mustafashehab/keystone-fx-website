    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 -mt-32 relative z-10">
          <div className="group rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-xl transition-all hover:border-yellow-400 hover:shadow-2xl hover:-translate-y-2">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">{t(lang, "contact.info.phone.title")}</h3>
            <p className="text-slate-600 mb-2">{t(lang, "contact.info.phone.description")}</p>
            <a href="tel:+447511648370" className="text-2xl font-bold text-slate-900 hover:text-yellow-600 transition">+44 7511 648370</a>
          </div>

          <div className="group rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-xl transition-all hover:border-yellow-400 hover:shadow-2xl hover:-translate-y-2">
            <div className="mb-6 inline-block rounded-full bg-yellow-400 p-4 text-4xl shadow-lg group-hover:scale-110 transition-transform">✉️</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">{t(lang, "contact.info.email.title")}</h3>
            <p className="text-slate-600 mb-2">{t(lang, "contact.info.email.description")}</p>
            <a href="mailto:info@keystone-fx.com" className="text-lg font-bold text-slate-900 hover:text-yellow-600 transition break-all">info@keystone-fx.com</a>
          </div>

          <div className="group rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-xl transition-all hover:border-yellow-400 hover:shadow-2xl hover:-translate-y-2">
            <div className="mb-6 inline-block rounded-full bg-yellow-400 p-4 text-4xl shadow-lg group-hover:scale-110 transition-transform">🕒</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">{t(lang, "contact.info.hours.title")}</h3>
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-slate-900 mb-4">{t(lang, "contact.form.title")}</h2>
              <p className="text-slate-600 text-lg">{t(lang, "contact.form.subtitle")}</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="fullName" className="block text-sm font-semibold text-slate-700 mb-2">{t(lang, "contact.form.fullName")}</label>
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-semibold text-slate-700 mb-2">{t(lang, "contact.form.email")}</label>
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-semibold text-slate-700 mb-2">{t(lang, "contact.form.phone")}</label>
              ...
              <div>
                <label htmlFor="topic" className="block text-sm font-semibold text-slate-700 mb-2">{t(lang, "contact.form.topic")}</label>
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-semibold text-slate-700 mb-2">{t(lang, "contact.form.message")}</label>
                <textarea id="message" name="message" value={formData.message} onChange={handleChange} required rows={6}
                  ...
                  placeholder={t(lang, "contact.form.messagePlaceholder") as string}></textarea>
              </div>
          ...
          <div className="space-y-8">
            <div className="rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-lg">
              <div className="mb-6 inline-block rounded-full bg-yellow-400 p-4 text-4xl shadow-lg">📍</div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4">{t(lang, "contact.location.title")}</h3>
              <p className="text-slate-600 text-lg leading-relaxed mb-4">
                Charles Helou avenue, Dora - Beirut highway<br />
                Bourj Hammoud, Beirut, Lebanon
              </p>
              <a href="https://www.google.com/maps/search/?api=1&query=33.8955278,35.5444722" target="_blank" rel="noopener noreferrer"
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 p-16 text-center text-white shadow-2xl">
          <h2 className="text-4xl font-bold mb-6">{t(lang, "contact.cta.title")}</h2>
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">{t(lang, "contact.cta.subtitle")}</p>
