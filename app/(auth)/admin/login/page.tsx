...
export default function AdminLoginPage() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="fixed top-0 right-0 pointer-events-none" style={{ width: '400px', height: '400px', background: `radial-gradient(circle at 70% 30%, ${GOLD_GLOW} 0%, transparent 70%)` }} />
      <div className="fixed bottom-0 left-0 pointer-events-none" style={{ width: '300px', height: '300px', background: `radial-gradient(circle at 30% 70%, rgba(245,200,66,0.18) 0%, transparent 70%)` }} />
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex items-center gap-2 mt-1 px-3 py-0.5 rounded-full" style={{ background: GOLD_SOFT, border: `1px solid ${GOLD_BORDER}` }}>
            ...
            <p className="text-[10px] tracking-widest uppercase font-semibold" style={{ color: GOLD }}>Admin Console</p>
          </div>
        </div>
        ...
        >
          <div className="mb-6">
            <h1 className="text-lg font-bold" style={{ color: '#0f0a02' }}>Administrator Sign In</h1>
            <p className="text-xs mt-0.5" style={{ color: '#92816a' }}>Restricted to Keystone FX personnel only</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wider mb-1.5" style={{ color: '#6b5c3e' }}>Email</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wider mb-1.5" style={{ color: '#6b5c3e' }}>Password</label>
              <input
                type="password"
                placeholder="••••••••"
        ...
        <div className="flex items-center justify-center gap-2 mt-5">
          ...
          <p className="text-xs" style={{ color: '#a08c6e' }}>Keystone FX · Secure Admin Access</p>
          <div className="w-1 h-1 rounded-full" style={{ background: GOLD, boxShadow: `0 0 4px ${GOLD_NEON}` }} />
        </div>
      </div>
    </div>
