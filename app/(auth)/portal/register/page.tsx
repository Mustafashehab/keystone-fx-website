    ...
    return (
      <div className="animate-fade-in text-center">
        <div className="w-12 h-12 rounded-full bg-[var(--kfx-success-muted)] flex items-center justify-center mx-auto mb-4">
          <svg
            className="w-6 h-6 text-[var(--kfx-success)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <h2 className="text-xl font-semibold text-[var(--kfx-text)] mb-2">
          Check your email
        </h2>
        <p className="text-sm text-[var(--kfx-text-muted)]">
          We&apos;ve sent a confirmation link to your email address. Click it
          to activate your account and begin onboarding.
        </p>
        <Link
          href="/portal/login"
          className="kfx-btn-secondary mt-6 inline-flex"
        >
          Back to sign in
        </Link>
      </div>
    ...
    <div className="animate-fade-in">
      <div className="mb-7">
        ...
        <p className="text-sm text-[var(--kfx-text-muted)] mt-1.5">
          Start your Keystone FX client onboarding.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Alert variant="info">
          ...
          Your information will be used for regulatory compliance and account
